                                    ...
                                    <table className="table">
                                        ...
                                        <tbody>
                                                ...
                                                List.map((items, index) => {
                                                    return (
                                                        <tr key={index} >
                                                            ...
                                                            <td className="col-md-3"><i className="fas fa-rupee-sign" area-hidden="true"></i> â‚¹ {items.amount}  </td>
                                                        </tr>
                                                    )
                                                }):null
                                            }
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <strong><i className="fas fa-rupee-sign" area-hidden="true"></i> â‚¹ {sum}</strong>
                                                    </p>
                                                    {/* <p>
                                                        <strong><i className="fas fa-rupee-sign" area-hidden="true"></i> â‚¹ {Discount} </strong>
                                                    </p> */}
                                                    <p>
                                                        <strong><i className="fas fa-rupee-sign" area-hidden="true"></i> â‚¹ {sum}</strong>
                                                    </p>
                                            ...
                                            <tr style={{ color: '#F81D2D' }}>
                                                ...
                                                <td className="text-left"><h4><strong><i className="fas fa-rupee-sign" area-hidden="true"></i> â‚¹ {sum} </strong></h4></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
